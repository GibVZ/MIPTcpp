...
fig_b, ((lin_Ab, lin_Bb, lin_Cb), (log_Ab, log_Bb, log_Cb)) = plt.subplots(2, 3, figsize = (15, 10))

fig_b.suptitle('Smart search with binomial distribution')

draw_graphic(lin_Ab, log_Ab, 'A_binomial.txt', 'A')
draw_graphic(lin_Bb, log_Bb, 'B_binomial.txt', 'B')
draw_graphic(lin_Cb, log_Cb, 'C_binomial.txt', 'C')

fig.savefig('smart_Search.png')
fig_b.savefig('smart_Search_With_binomial.png')
